...
export default function Projects({
  ...
  useEffect(() => {
    async function getProjects() {
      const resp = await fetch(`/api/projects?userId=${id}`, {
        method: "GET",
        credentials: "include",
    ...
    <div className="flex justify-center mt-8">
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-md p-6">
        <div className="mb-4 text-center text-gray-700">
          <h2 className="text-lg font-semibold">List of projects for user id : {id}</h2>
        </div>
            ...
            {projects.map((project: Project) => (
              ...
              >
                ...
                <TableCell className="text-center flex justify-center gap-2">
                  ...
                  <Link
                    href={`/admin/users/${id}/projects/${project.id}/tasks`}
